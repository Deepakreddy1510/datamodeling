...
SEMANTIC_TOKEN_MAP = {
    ...
    "person_name": {"person_name", "customer_name", "employee_name", "patient_name", "member_name", "contact_name", "first_name", "last_name", "player_name"},
    "company_name": {"company", "organization", "organisation", "vendor", "supplier", "employer"},
    "product_or_service": {"product", "item", "service", "offering", "product_name", "item_name", "service_name", "offering_name"},
    "brand": {"brand", "maker"},
